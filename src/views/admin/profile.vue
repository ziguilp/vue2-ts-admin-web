                    ...
                    <div>
                        <el-form @submit.prevent="saveUserInfo">
                            ...
                            <el-form-item label="验证码">
                                <CaptchaVue
                                    :username="captchaForm.username"
                                    :event="captchaForm.event"
...
export default class extends Vue {
    ...
    private captchaForm = {
        username: this.userInfo.mobile || (this.userInfo as any).email,
        event: CaptchaVerifyEventType.MODIFY_PASSWORD,
        captcha: "",
    };
    ...
    private async handleSave() {
        ...
        const res = await modifyPwd({
            captchaVerifyData: this.captchaForm,
