      ...
      <div :class="`upload-show ${disabled ? 'disabled' : ''}`">
        <slot v-bind:uploaded="uploaded">
          <ul class="file-list">
            ...
            <li class="file-list-item" v-if="max > uploaded.length && uploadingNum === 0">
...
export default class extends Vue {
  ...
  changeModelVal() {
    setTimeout(() => {
      let images: string[] = this.value instanceof Array ? this.value : [];
  ...
  private updateUploadItem(e: UploadedFile) {
